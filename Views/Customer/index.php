...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                   <li class="nav-item">
                    ...
                    <li class="nav-item dropdown" style="margin-left: 30px;">
                        ...
                        <?php if(isset($_COOKIE['AuthenticationUser'])) : ?>
                            <div class="dropdown-menu bg-aqua user-exist">
                                <div class="title">Xin chào, <?php echo $data['User']['TenKH'] ?></div>
                                <hr>
                                <a class="history nav nav-link">Lịch sử mua hàng</a>
                                <a class="account nav nav-link" href="">Chỉnh sửa tài khoản</a>
                        ...
                        <?php elseif(isset($_COOKIE['AuthenticationAdmin'])) : ?>
                            <div class="dropdown-menu bg-aqua user-exist">
                                ...
                                <a class="history nav nav-link">Lịch sử mua hàng</a>
                                <a class="account nav nav-link" href="">Chỉnh sửa tài khoản</a>
                                <a class="account nav nav-link" href="">Trang quản lý</a>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="sidebar-title">
                            ...
                            <span id="username" style="font-size: 24px;"><?php echo $data['User']['TenKH'] ?></span>
                        </div>
                        <hr>
                        <div class="sidebar">
                            <ul class="nav nav-pills mb-auto flex-column">
                                <li class="nav-item">
                                    <a href="http://localhost/MVC_QLPT/Account/index" class="nav-link"><i class="bi bi-person-circle"></i>Thông tin khách hàng</a>
                                </li>
                                <li class="nav-item">
                                    <a href="http://localhost/MVC_QLPT/Account/orderHistory" class="nav-link"><i class="bi bi-list"></i>Lịch sử đơn hàng</a>
                                </li>
                                <li class="nav-item">
                                    <a href="http://localhost/MVC_QLPT/Account/Address" class="nav-link"><i class="bi bi-house-fill"></i>Chỉnh sửa địa chỉ</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <script src="http://localhost/MVC_QLPT/Content/bootstrap/js/bootstrap.js" type="text/javascript"></script>
<script src="http://localhost/MVC_QLPT/Content/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="http://localhost/MVC_QLPT/Content/bootstrap/js/bootstrap.bundle.js" type="text/javascript"></script>
