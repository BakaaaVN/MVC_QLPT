        ...
        <div class="box-root flex-flex flex-direction--column" style="min-height: 100vh;flex-grow: 1;">
            ...
            <div class="box-root padding-top--24 flex-flex flex-direction--column" style="flex-grow: 1; z-index: 9;">
                <div class="box-root padding-top--48 padding-bottom--24 flex-flex flex-justifyContent--center">
                    <h1><a href="#" rel="dofollow">Pharmacity</a></h1>
                </div>
                <form class="formbg-outer" id="loginForm">
                    <div class="formbg">
                        <div class="formbg-inner padding-horizontal--48">
                            <span class="padding-bottom--15 title">Trang đăng nhập</span>
                            <div id="stripe-login">
                                ...
                                <div class="field padding-bottom--15" id="error-message"></div>
                                <div class="field padding-bottom--24">
                                    <input type="submit" class="btn btn-primary" id="loginButton" value="Đăng nhập"></input>
                                </div>
                                <div class="field padding-bottom--15" style="text-align: center;">
                                    <span style="font-size:15px;">Chưa có tài khoản?<a href=""> Đăng ký</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    var errMess = document.getElementById('error-message');
    ...
    $('document').ready(function() {
        document.getElementById('loginForm').addEventListener('submit', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "http://localhost/MVC_QLPT/AuthenticationUser/UserLogin",
                data: JSON.stringify({
                    username: username,
                    password: password
                }),
                ...
                success: function (response) {
                    ...
                    errMess.innerHTML = "Tên tài khoản hoặc mật khẩu không đúng."
