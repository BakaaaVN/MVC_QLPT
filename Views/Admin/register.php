                ...
                <form class="formbg-outer" id="loginForm">
                    <div class="formbg">
                        <div class="formbg-inner padding-horizontal--48">
                            <span class="padding-bottom--15 title">Đăng ký tài khoản</span>
                            <div id="stripe-login">
                                ...
                                <div class="field padding-bottom--24">
                                    <input type="submit" class="btn btn-primary" id="loginButton" value="Đăng ký"></input>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    $('document').ready(function() {
        $('#loginButton').click(function(e) {
            ...
            if(username != '' && password != '') {
                $.ajax({
                type: "POST",
                url: "http://localhost/MVC_QLPT/AuthenticationAdmin/AdminLogin/",
                data: JSON.stringify({
                    username: username,
                    password: password
                }),
